...
const InventoryCart = ({ filteredCars }) => {
        ...
        >
          <CardContent className="p-6 flex flex-col h-full">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <button
                    ...
                    aria-label="Edit car"
                    onClick={() =>
                      navigate(`/dashboard/inventory/edit/${car._id}`)
                    }
                    tabIndex={0}
                  >
                ...
                <div className="flex sm:flex-row gap-1 sm:gap-3 text-gray-500 text-sm">
                  <span className="font-semibold">
                    Model:{" "}
                    <span className="font-normal">{car.carModel || "N/A"}</span>
                  </span>
                </div>
              </div>
            </div>
            <div className="flex flex-wrap gap-2 mb-2 text-xs text-gray-600">
              ...
              <span className="bg-gray-100 px-2 py-1 rounded">
                Cost Price: Rs {car.costPrice ?? "N/A"}
              </span>
              <span className="bg-gray-100 px-2 py-1 rounded">
                Selling Price: Rs {car.sellingPrice ?? "N/A"}
              </span>
            </div>
            <div className="mt-auto flex justify-between items-end pt-4">
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  type="button"
                  onClick={() => navigate(`/dashboard/inventory/${car._id}`)}
                >
                  Details
                </Button>
              </div>
